...
1. **Clone the repository:**
  ```bash
   git clone https://github.com/Rabieulawal/rubber-duck.git
   cd rubber-duck
...
this should give you the port you need and then enjoy debuging

## ai usage

ai help was used in the js part and setting up the backend. 